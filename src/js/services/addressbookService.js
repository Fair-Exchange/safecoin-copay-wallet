...
angular.module('copayApp.services').factory('addressbookService', function($log, bitcoreSafe, storageService, lodash) {
  var root = {};

  var getNetwork = function(address) {
    var network;
    network = (new bitcoreSafe.Address(address)).network.name;
    return network;
  };
  ...
  root.add = function(entry, cb) {
    ...
    if (lodash.isEmpty(network)) return cb('Not valid safecoin address');
