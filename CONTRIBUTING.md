...
# Contributing to Safecoin Wallet
...
issues](https://github.com/OleksandrBlack/safecoin-copay-wallet/issues) in order to learn if the issue is already reported. It could be fixed already.
...
provide the following information:
 ...
 - Which version of Safecoin Wallet are you using? (Check Safecoin Wallet version on the side menu)
 ...
 - Please check Safecoin Wallet logs (General Settings -> About Safecoin Wallet -> Session Logs). Look for
...
To open an issue go to [Github Issues](https://github.com/OleksandrBlack/safecoin-copay-wallet/issues).
...
Please adhere to the coding conventions used throughout Safecoin Wallet (indentation, tests, etc.)
